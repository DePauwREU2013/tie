/*
   file: k_k_/graphics/tie/fmt/graphics2d.scala
...
trait Small_File_Size
    extends Catenated_Transforms{ self: Graphics2D_Content_Renderer =>
}


object Graphics2D_Renderer extends Graphics2D_Renderer

object Size_Optimized_Graphics2D_Renderer extends Graphics2D_Renderer with Small_File_Size
...
object Graphics2D_Elem_Renderer extends Graphics2D_Elem_Renderer
...
object Graphics2D_Frag_Renderer extends Graphics2D_Frag_Renderer

class Graphics2D_Frag_Renderer extends Graphics2D_Content_Renderer {
...
sealed abstract class Graphics2D_Content_Renderer extends Graphics2D_Renderer_Base {
...
//    os.write(fmt_epilogue())
  ...
  protected sealed class Defs(val defs: List[Def],
                              protected[Graphics2D_Content_Renderer]
  ...
  protected final class Define_Defs(protected[Graphics2D_Content_Renderer]
